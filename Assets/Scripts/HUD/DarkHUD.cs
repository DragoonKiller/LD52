...
public class DarkHUD : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        World.Instance.OnDarkEnergyChangeEvent += ChangeValueView;
        World.Instance.OnDarkLevelChangeEvent += ChangeLevelNum;
        World.Instance.InitDarkUIFrameEvent += InitValueFrame;
    }
